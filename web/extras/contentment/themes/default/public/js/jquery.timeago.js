...
return $t.distanceInWords(new Date(timestamp),lang);return $t.distanceInWords($t.datetime(timestamp),lang);};$.extend($t,{interval:null,settings:{refreshMillis:60000,allowFuture:true,deviance:0,strings:{prefixAgo:null,prefixFromNow:null,suffixAgo:"ago",suffixFromNow:"from now",seconds:"less than a minute",minute:"about a minute",minutes:"%d minutes",hour:"about an hour",hours:"about %d hours",day:"a day",days:"%d days",month:"about a month",months:"%d months",year:"about a year",years:"%d years",numbers:[]}},strings:function(lang)
...
$t.interval=window.setInterval($t.refreshAll,$s.refreshMillis);return this;};document.createElement("abbr");document.createElement("time");})(jQuery);$(function(){jQuery('abbr.datetime,time').timeago();});