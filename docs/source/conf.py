...
html_title = "Contentment %s Documentation" % (version, )
...
htmlhelp_basename = 'contentment-doc'
...
latex_documents = [
  ('index', 'contentment.tex', u'Contentment Documentation', u'Alice Bevan-McGregor', 'manual'),
]
